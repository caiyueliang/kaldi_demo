...
echo "[RUN]  train_set: "${train_set}
echo "[RUN]    dev_set: "${dev_set}
echo "[RUN]   test_set: "${test_set}
...
echo "[RUN] 24 =================================="
CUDA_VISIBLE_DEVICES=2 nohup bash local/nnet/run_dnn.sh --stage 0 --feats_gen 1 --nj ${nj} \
